...
$defProp(Object.prototype, "setProperty$2", function($0, $1) {
  return this.noSuchMethod("setProperty", [$0, $1]);
});
...
$dynamic("setProperty$2").CSSStyleDeclaration = function($0, $1) {
...
ShipsClient.prototype.createPlayground = function(tableId, operationName, state) {
  var $this = this; // closure support
  var table = get$$document().query($add$("#", tableId));
  for (var i = (0);
   $lt$(i, (10)); i = $add$(i, (1))) {
    ...
    for (var j = (0);
     $lt$(j, (10)); j = $add$(j, (1))) {
      ...
      var coordinates = $add$($add$($add$("", i), "-"), j);
      cell.set$text("");
      cell.bgColor = "lightgray";
      cell.height = "15";
      cell.width = "15";
      cell.set$id($add$($add$(tableId, "-"), coordinates));
      cell.get$on().get$click().add$1((function (coordinates, e) {
        if (state == $this._gameState) {
          $this.request(operationName, _map(["coordinates", coordinates]));
        }
      }).bind(null, coordinates)
      );
    }
  }
}
ShipsClient.prototype.dataReceived = function(e) {
  print$(e.data);
  ...
  for (var $$i = data.iterator(); $$i.hasNext(); ) {
    ...
    else if ("placeShip" == msg.$index("operation")) {
      var id = $add$($add$($add$("#", msg.$index("sea")), "-sea-"), msg.$index("coordinates"));
      var cell = get$$document().query(id);
      cell.bgColor = "blue";
    }
...
ShipsClient.prototype.get$dataReceived = function() {
  return this.dataReceived.bind(this);
}
...
ShipsClient.prototype.write = function(message) {
